		...
		<!-- Wrapper -->
			...
			<nav id="menu">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>Noida Construction<span class="pull-right"></span></h1>
							...
							<div class="container-fluid">
								<div class="row">
										...
										<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										  ...
										  <div class="carousel-inner">
										    <div class="carousel-item active">
										      <img class="d-block w-100" src="images/noida.jpg" alt="First slide">
										    </div>
									...
									<div class="col-lg-5">
										...
										<p>Employer - Noida Construction<br>Category - Construction Worker<br>Salary - Rs 20,000/month<br>Location - Noida</p>
										<?php 
											$_SESSION['employer'] = "Noida Construction";
											$_SESSION['category'] = " Construction Worker";
											$_SESSION['salary'] = "Rs 20,000/month";
											$_SESSION['location'] = "Noida";
										?>
							...
							<div class="container-fluid">
								...
								<div class="row">
									<div class="col-md-3">
										...
										<ul class="alt">
											<li><span class="fa fa-user"></span>Riya Sharma</li>
											<li><span class="fa fa-mobile-phone"></span> +91 333 4040 556 </li>
											<li><span class="fa fa-envelope-o"></span> <a href="">riya@gmail.com</a></li>
