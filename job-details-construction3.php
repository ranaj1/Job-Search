		...
		<!-- Wrapper -->
			...
			<nav id="menu">
				...
				<ul>
					...
					<div id="main">
						<div class="inner">
							<h1>Delhi Construction<span class="pull-right"></span></h1>
							...
							<div class="container-fluid">
								<div class="row">
										...
										<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										  ...
										  <div class="carousel-inner">
										    <div class="carousel-item active">
										      <img class="d-block w-100" src="images/delhi6.jpg" alt="First slide">
										    </div>
									...
									<div class="col-lg-5">
										...
										<p>Employer - Delhi Construction<br>Category - Construction Worker<br>Salary - Rs 30,000/month<br>Location - Delhi</p>
										<?php 
											$_SESSION['employer'] = "Delhi Construction";
